...
<body>
    ...
    <!-- ============================================================== -->
    <div id="main-wrapper" data-theme="light" data-layout="horizontal" data-navbarbg="skin1" data-sidebartype="mini-sidebar" data-boxed-layout="boxed">
        <!-- ============================================================== -->
                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin1">
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            @if(Route::has('login')) 
                                @auth
                                    <a href="/Profile"><font color="white" size="4" >Go to profile page</font></a>
                                    @else
                                        <a href="/login"><font color="white" size="4" >Login</font></a>
                                        @if(Route::has('register'))
                                            &nbsp;
                                            &nbsp;
                                            <a href="/register"><font color="white" size="4" >Sign Up</font></a>
                                        @endif
                                @endauth
                            @endif
                            ...
                            <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                                ...
                                <div class="d-flex no-block align-items-center p-15 bg-primary text-white m-b-10">
                                    <div class="">
                                        <img src="{{asset('admin/assets/images/users/9.jpg')}}" alt="user" class="img-circle" width="60">
                                    </div>
                                    <div class="m-l-10">
                                        <h4 class="m-b-0">Nayyef Firdaus</h4>
                                        <p class=" m-b-0">nayyeffirdaus@nf.com</p>
                                    </div>
                                </div>
    ...
    <aside class="customizer">
        ...
        <div class="customizer-body ps-container ps-theme-default" data-ps-id="aea917a0-f681-f90a-7b47-6ed0416f83de">
            ...
            <div class="tab-content" id="pills-tabContent">
                ...
                <div class="tab-pane fade" id="chat" role="tabpanel" aria-labelledby="pills-profile-tab">
                    <ul class="mailbox list-style-none m-t-20">
                        <li>
                            <div class="message-center chat-scroll ps-container ps-theme-default" data-ps-id="21019967-6998-5424-0ed0-155c9ccc4704">
