                        ...
                        <div class="col-12">
                            ...
                            {{csrf_field()}}
                                <div class="form-group row ">
									...
									<div class="col-12 ">
                                        <input class="form-control" type="text" required=" " placeholder="Your Name" name="name" required>
                                        @error('name')
                                ...
                                <div class="form-group row">
                                    <div class="col-12 ">
                                        <input class="form-control" type="text" required=" " placeholder="Email" name="email" required>
                                        @error('email')
                                             <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
