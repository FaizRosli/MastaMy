    ...
    <div class="main-wrapper">
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center" style="background:url({{asset('admin/assets/images/big/auth-bg32.jpg')}}) no-repeat center center;">            
            ...
            <div class="auth-box">
                <div id="loginform">
					<div class="logo">
                        <span class="db"><img src="{{asset('admin/assets/images/logo-icon2.png')}}" alt="logo" style="padding:20px;"/></span>
                        <h3 class="font-medium m-b-20">Log In</h3>
                    </div>
                    <!-- Form -->
                    <div class="row">
                        <div class="col-12">
                            <form class="form-horizontal m-t-20" id="loginform" action="/login" method="post">
                                ...
                                <div class="form-group row">
                                    <div class="col-md-12">
                                        <div class="custom-control custom-checkbox">
                                            ...
                                            <a href="/reset" class="text-dark float-right"><i class="fa fa-lock m-r-5"></i> Forgot password</a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                @error('email')
                                     <div class="alert alert-danger"> woiiii !!! <br> salah emel atau password</div>
                                @enderror
                            </form>
                        </div>
